...
| Consulta histórico de vendas (`FRMCONSHISTVENDAS`) | 841 | 25 | leitura | — | **próximo** — não migrado (verificado no código); leve, e é o candidato de retaguarda com mais operadores na fila |
