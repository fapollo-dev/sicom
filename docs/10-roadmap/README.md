...
| [placar-conversao.md](placar-conversao.md) | **Quanto do legado já virou plataforma nova** — cruza o inventário do legado (~165 telas de negócio) com o que está entregue e verde, em três eixos (contagem de telas · peso/complexidade · avanço por fase). Fonte única e rastreável do "% convertido"; atualizar a cada corte que fecha uma tela. |
