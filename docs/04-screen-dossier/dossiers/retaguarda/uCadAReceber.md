...
| Campo | Valor |
|---|---|
| **Status** | corte-1 (cadastro/gestão) + corte-2 (baixa/recebimento núcleo) ENTREGUES 2026-07-02; corte-3a (baixa PARCIAL, migration 054) + corte-3b (CONTÁBIL da baixa DINHEIRO, migration 055) ENTREGUES e verdes 2026-07-04 (smoke 366/0), AR+AP. Recon por 3 agentes; cada corte auditado (adversarial 2 agentes: paridade vs Oracle real + não-regressão). |
