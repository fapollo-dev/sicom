...
| PROMOCAO ACUMULATIVA (`FRMCADPROMOCAOACUMULATIVA`) | 199 | 26 | 2026-08-24 | ✅ **completa** (mig 214): cadastro, as 4 validações na ordem do legado (período com hora, qtde/desconto/loja, colisão por produto e por grupo de preço), a lista de lojas no formato `;1;2;`, produto ativo e exclusão |
