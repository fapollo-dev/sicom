...
| PRECIFICACAO NF (`FRMPRECIFICACAONF`) | 236 | 17 | 2026-08-25 | 🟡 **cortes 1+2** (mig 211): 22 das 35 colunas, os **3 tipos de custo** com as escadas do legado, markup nas 3 semânticas (a do CSI é margem líquida), rodapé com os 3 lucros, 4 dos 5 atalhos e o lote fiel. Falta: produtos filhos, multi-empresa na tela, relatório .fr3, fila de etiquetas, coloração por regra — §8.3 do dossiê |
