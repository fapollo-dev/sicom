...
| 19 | `FRMPRECIFICACAOPROD` | 67 | 7 | 🔁 **veredito ERRADO, reaberta (23/09/2026)**: "sem fonte" — o fonte existe, `uFrmPrecificacaoProd.pas` (lição 121). Reavaliar |
...
| 50 | `FRMLANFRETE` | 27 | 4 | 🔁 **veredito ERRADO, reaberta (23/09/2026)**: "sem fonte" — o fonte existe, `UlancFrete.pas` (a busca foi pelo nome da unit, e o `grep` do shell devolve vazio em arquivo latin1; lição 121). Reavaliar |
