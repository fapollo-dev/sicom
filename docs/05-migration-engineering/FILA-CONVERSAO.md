...
origem 'NF'; o Apollo não gera nenhum). Dossiê `UCadSituacaoNF.md`: **C1 (a tela) ✅ mig 317**; C2 NF×CFOP, C3 rateio, C4 caixa da NF, C5 pesquisas fora da NF e C6 regras pequenas na fila — os itens 3 e 4 desta tabela entram neles.
