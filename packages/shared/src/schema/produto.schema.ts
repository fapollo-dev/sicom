...
const produtoBase = z.object({
  ...
  // mig 278: a classificação tributária da reforma (cClassTrib). 44.501 dos 47.729 produtos do cliente
  // já a têm, e é ela que decide a redução de IBS/CBS do item na nota.
  codclass_trib: z.coerce.number().int().positive().nullable().optional(),
