...
const TELAS = [
  ...
  { href: '/cadastro/situacao-documento', name: 'Situação do documento', icon: FileText },
  ...
  { href: '/cobranca/extrato-clientes', name: 'Extrato de clientes', icon: UserSearch },
  ...
  { href: '/fiscal/config-legislacao', name: 'Legislação da NF-e', icon: FileSearch },
  ...
  { href: '/relatorios/devolucao-vendas', name: 'Devolução de vendas', icon: Undo2 },
