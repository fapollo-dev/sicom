...
const MODELOS: { value: string; label: string; render: () => ReactNode }[] = [
  ...
  { value: 'vendas-extras', label: '03/15/16/21/22/26/29/31/33/34/35/37/39/40/42/43/45/47/49/50 · Complementares (cliente, fiscais, ICMS, grade…)', render: () => <RelVendasExtrasPage /> },
