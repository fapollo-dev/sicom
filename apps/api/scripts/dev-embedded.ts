...
async function provisionarLoginDev(): Promise<void> {
  ...
  const PARES: Array<[string, string]> = [
    ...
    ['FRMNFANALISE', 'FRMNFANALISE'], ['FRMSALDOEMPRESA', 'FRMSALDOEMPRESA'], ['FRMRELCAIXA', 'FRMRELCAIXA'], ['FRMCONSULTORIAATM', 'FRMCONSULTORIAATM'], ['FRMRELCARTOES', 'FRMRELCARTOES'], ['FRMRELLANCAMENTOSCONTABEIS', 'FRMRELLANCAMENTOSCONTABEIS'],
  ];
