...
async function provisionarLoginDev(): Promise<void> {
  ...
  const CRUD_FORMS = [
    ...
    'FRMCADOPERADOR', 'FRMCADPERFILOPERADOR', 'FRMCADTABELAPRECO', 'FRMCADPRODUTO', 'FRMCADSITUACAONF', 'FRMCADUNIDADE',
    'FRMCADDEVOLUCAO', 'FRMNF', 'FRMPEDIDOCOMPRA', 'FRMCADAGENDAPROMOCAO',
  ];
  ...
  const PARES: Array<[string, string]> = [
    ...
    ['FRMCADDEVOLUCAO', 'BTNCANCELAR'], ['FRMCADDEVOLUCAO', 'BTNFATURAR'], ['FRMCADDEVOLUCAO', 'BTNFINALIZAR'], ['FRMCADDEVOLUCAO', 'BTNGERARNF'], ['FRMCADDEVOLUCAO', 'BTNREABRIR'],
