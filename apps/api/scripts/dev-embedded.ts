...
async function provisionarLoginDev(): Promise<void> {
  ...
  const CRUD_FORMS = [
    'FRMCADALIQUOTA', 'FRMCADBAIRRO', 'FRMCADPLC', 'FRMCADCFOP', 'FRMCADCIDADES', 'FRMCADCLIENTES',
    'FRMCADCONDICOESPAGTO', 'FRMCADCONTASBANCARIAS', 'FRMCADEMPRESA', 'FRMCADFAMILIAPROD', 'FRMCADFORMAPGTO',
    'FRMCADLOTECOBRANCA', 'FRMCADMARCAS', 'FRMCADMOTIVOOPERACOES', 'FRMCADNCM', 'FRMCADOPERACOESCONTA',
    'FRMCADUSUARIOS', 'FRMCADPERFILOPERADOR', 'FRMCADTABELAPRECO', 'FRMCADPRODUTO', 'FRMCADSITUACAONF', 'FRMCADUNIDADE',
    'FRMCADPEDIDODEVOLUCAOCOMPRAS', 'FRMNF', 'FRMPEDIDOCOMPRA', 'FRMCADAGENDAPROMOCAO',
  ];
  ...
  const PARES: Array<[string, string]> = [
    ['FRMCADAGENDAPROMOCAO', 'BTNAPLICARPRECO'], ['FRMCADAGENDAPROMOCAO', 'BTNENCERRAR'],
    ['FRMAJUSTEESTOQUE', 'BTNOK'], ['FRMAJUSTEESTOQUE', 'BTNESTORNAR'],
    ...
    ['FRMCADPEDIDODEVOLUCAOCOMPRAS', 'BTNCANCELAR'], ['FRMCADPEDIDODEVOLUCAOCOMPRAS', 'BTNFATURAR'], ['FRMCADPEDIDODEVOLUCAOCOMPRAS', 'BTNFINALIZAR'], ['FRMCADPEDIDODEVOLUCAOCOMPRAS', 'BTNGERARNF'], ['FRMCADPEDIDODEVOLUCAOCOMPRAS', 'BTNREABRIR'],
    ['FRMRELDRECONTABIL', 'BTNVISUALIZAR'],
    ['FRMLIBERACOES', 'BTNCONSULTAR'], ['FRMLIBERACOES', 'BTNPERMISSOES'],
    ['FRMNF', 'CANCELARNFE1'], ['FRMNF', 'BTNCARTACORRECAO'], ['FRMNF', 'BTNCONTABILIZAR'], ['FRMNF', 'BTNESTORNARCONTABIL'], ['FRMNF', 'BTNESTORNARFATURAMENTO'], ['FRMNF', 'BTNFATURAMENTO'], ['FRMNF', 'BTNPROCESSAR'], ['FRMNF', 'BTNREVERTER'], ['FRMNF', 'ENVIARNFE1'],
    ...
    ['FRMNFANALISE', 'FRMNFANALISE'], ['FRMSALDOEMPRESA', 'FRMSALDOEMPRESA'], ['FRMRELCAIXA', 'FRMRELCAIXA'], ['FRMCONSULTORIAATM', 'FRMCONSULTORIAATM'], ['FRMRELCARTOES', 'FRMRELCARTOES'], ['FRMRELLANCAMENTOSCONTABEIS', 'FRMRELLANCAMENTOSCONTABEIS'], ['FRMRENTABILIDADECATEGORIAS', 'FRMRENTABILIDADECATEGORIAS'],
    ['FRMPRECIFICACAONF', 'FRMPRECIFICACAONF'], ['FRMPRECIFICACAONF', 'BTNAPLICAR'],
  ];
