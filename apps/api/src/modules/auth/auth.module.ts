...
import { RestricaoAcessoController } from './restricao-acesso.controller';
...
@Module({
  controllers: [AuthController, LiberacaoController, RestricaoAcessoController],
  providers: [AuthService, LiberacaoService, RestricaoAcessoService, ConfigService, DatabaseProvider],
